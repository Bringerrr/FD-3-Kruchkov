...
var client_select = function client_select(active) {
  return {
    type: CLIENT_SELECT,
    active: active
  };
...
var set_name = function set_name(name) {
  return {
    type: COMPANY_NAME,
    name: name
  };
...
var set_balance = function set_balance(client_id, balance) {
  return {
    type: SET_BALANCE,
    clientid: clientid,
    balance: balance
...
exports.client_select = client_select;
exports.CLIENT_SELECT = CLIENT_SELECT;
...
var _MobileCompany = __webpack_require__(67);
...
var clientsArr = [{ id: 101, fio: "Иванов И.И.", balance: 200 }, { id: 105, fio: "Сидоров С.С.", balance: 250 }, { id: 110, fio: "Петров П.П.", balance: 180 }, { id: 120, fio: "Григорьев Г.Г.", balance: 220 }];
...
_reactDom2.default.render(_react2.default.createElement(
  ...
  { store: store },
  _react2.default.createElement(_MobileCompany2.default, {
    name: companyName,
    clients: clientsArr
  })
...
*/
var aa=__webpack_require__(14),ba=__webpack_require__(1),m=__webpack_require__(15),p=__webpack_require__(16),v=__webpack_require__(8),da=__webpack_require__(17),ea=__webpack_require__(18),fa=__webpack_require__(19),ha=__webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mergeProps__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__selectorFactory__ = __webpack_require__(65);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var _reduxConst = __webpack_require__(3);

var _deepEqual = __webpack_require__(68);

var _deepEqual2 = _interopRequireDefault(_deepEqual);

var _MobileClient = __webpack_require__(71);
...
var MobileCompany = function (_React$PureComponent) {
  ...
  function MobileCompany() {
    ...
    }, _this.nameChange1 = function () {
      _this.props.dispatch((0, _reduxConst.set_name)("МТС"));
    }, _this.nameChange2 = function () {
      _this.props.dispatch((0, _reduxConst.set_name)("Velcom"));
  ...
  _createClass(MobileCompany, [{
    ...
    value: function render() {
      ...
      var clientsCode = this.props.clientRedux.clientsRedux.map(function (client) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('br', null),
          _react2.default.createElement('input', { type: 'button', value: '=\u041C\u0422\u0421', onClick: this.nameChange1 }),
          _react2.default.createElement('input', { type: 'button', value: '=Velcom', onClick: this.nameChange2 }),
          _react2.default.createElement(
            'div',
            { className: 'MobileCompanyName' },
            '\u041A\u043E\u043C\u043F\u0430\u043D\u0438\u044F \xAB',
...
var MobileClient = function (_React$PureComponent) {
  ...
  function MobileClient() {
    ...
    }, _this.clientSelect = function (elem) {
      _this.props.dispatch((0, _reduxConst.client_select)(elem));
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(MobileClient, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'MobileClient', onClick: function onClick() {
            _this2.clientSelect(_this2.state.info);
          } },
        _react2.default.createElement(
          'span',
...
exports.default = (0, _reactRedux.connect)()(MobileClient);
...
var _clientsSelect = __webpack_require__(75);

var _clientsSelect2 = _interopRequireDefault(_clientsSelect);

var _setBalance = __webpack_require__(76);

var _setBalance2 = _interopRequireDefault(_setBalance);

var _setName = __webpack_require__(77);
...
var combinedReducer = (0, _redux.combineReducers)({
    ...
    clients: _clientsSelect2.default,
    // active: activeClient,
    // balance: setBalance,
    name: _setName2.default
    // + другие редьюсеры
});
...
var initState = {
    ...
    clientsRedux: [{ id: 101, fio: "Иванов И.И.", balance: 200 }, { id: 105, fio: "Сидоров С.С.", balance: 250 }, { id: 110, fio: "Петров П.П.", balance: 180 }, { id: 120, fio: "Григорьев Г.Г.", balance: 220 }],
    active: null,
    maxBalance: 999
};
...
function clientSelect() {
    ...
    switch (action.type) {
        ...
        case _reduxConst.CLIENT_SELECT:
            {
                // console.log('ClientActive:',action);
                // console.log('ClientActive:',state.active);
                var changed = false;
                var newState = {};
                var newClients = [].concat(_toConsumableArray(state.clientsRedux)); // копия самого массива клиентов
                newClients.forEach(function (c, i) {
...
function setBalance() {
    ...
    switch (action.type) {
        ...
        case _reduxConst.SET_BALANCE:
            {
                var changed = false;
                var newClients = [].concat(_toConsumableArray(this.state.clients)); // копия самого массива клиентов
                newClients.forEach(function (c, i) {
                ...
                if (changed) console.log(action.clientid);
                console.log(state);
                //   this.setState({clients:newClients});
            }
...
function setName() {
    ...
    switch (action.type) {
        ...
        case _reduxConst.COMPANY_NAME:
            {

                if (state.name === action.name) {
                    console.log("do nothing");
                } else console.log("New state : " + action.name);
                state = _extends({}, state, { name: action.name });
            }
